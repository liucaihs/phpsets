              ...
              <div class="panel panel-success">
                ...
                <form class="form-horizontal" style="margin-top: 20px;margin-left: 18%;" method="POST" onsubmit="return add();" id="subform">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                          <select class="form-control" style="width: 285px;" id="ad_id" name="ad_id">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" style="width: 285px;" id="media_id0" name="media_id">
                                <option value=""> =请选择= </option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" placeholder="任务名称" style="width: 285px;" id="ad_name0" name="adput_name">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" placeholder="单价" style="width: 285px;" id="price" name="price">
                      </div>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">日均限量</label>
                        <div class="col-sm-9">
                            <input type="number" class="form-control" placeholder="日均限量" style="width: 285px;" id="limited" name="limited">
                        </div>
                    </div>
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-3 control-label">扣量比率</label>
                      <div class="col-sm-9">
                        <input type="number" class="form-control" placeholder="扣量比率%" style="width: 285px;" id="reduction" name="reduction">
                      </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="input-append date form_datetime" id="form_datetime0">
                                开始时间：
                                <input size="16" type="text" placeholder="开始时间"  readonly style="width: 200px;" id="start_time" name="start_time">
                                <span class="add-on"><i class="icon-th"></i></span>
                            </div><br/>
                            <div class="input-append date form_datetime" id="form_datetime1">
                                结束时间：
                                <input size="16" type="text"  placeholder="结束时间"    readonly style="width: 200px;" id="end_time" name="end_time">
                                <span class="add-on"><i class="icon-th"></i></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                       <input type="text" class="form-control" placeholder="投放链接/包" style="width: 285px;" id="puton_url" name="puton_url">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <label for="inputPassword3" class="col-sm-3 control-label">渠道接口地址</label>
                      <div class="col-sm-9">
                        <label  class="col-sm-5 control-label">{{$adx_click}}</label>
                      </div>
                    </div>
                    <div class="form-group" id="useapishow">
                      <label for="inputPassword3" class="col-sm-3 control-label">渠道回调链接</label>
                      <div class="col-sm-9">
                       <input type="text" class="form-control" placeholder="回调链接" style="width: 285px;" id="channel_url" name="channel_url">
                      </div>
                    </div>
...
$(document).ready(function(){
    ...
    getall_zxcq("{{url('channel/select')}}", "media_id0");
