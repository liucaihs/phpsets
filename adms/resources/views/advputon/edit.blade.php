          ...
          <div class="col-md-6 col-sm-12">
              <div class="panel panel-success">
                <div class="panel-heading">
                  <h3 class="panel-title">投放广告编辑</h3>
                </div>
                <form class="form-horizontal" style="margin-top: 20px;margin-left: 18%;" method="POST" onsubmit="return add();" id="subform">
                    ...
                    <div class="form-group" >
                        ...
                        <div class="col-sm-9">
                            <label  class="col-sm-5 control-label"> {{$adx_click.$row->adput_sn}} </label>
                        </div>
                    </div>
                    <div class="form-group" id="useapishow">
                      <label for="channel_url" class="col-sm-3 control-label">回调链接</label>
                      <div class="col-sm-9">
                    ...
                    <div class="form-group">
                      <label for="remark" class="col-sm-3 control-label">要求说明</label>
                      <div class="col-sm-9">
